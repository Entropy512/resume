...
\begin{ressection}{Skills}
	...
	\begin{reslist}{\textbf{Other Tools:}}
		\ressubitem{Familiarity with Cadsoft Eagle, Creo Schematic, and KiCad}
		\ressubitem{Familiarity with Ghidra software reverse engineering toolkit}
	\end{reslist}
