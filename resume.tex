...
\newcommand{\addra}{21 Adams Road}
\newcommand{\addrb}{Martinsville, NJ 08836}
\newcommand{\addr}{\addra, \addrb}
\newcommand{\hphone}{(732) 560-7137}
\newcommand{\phone}{(908) 770-0158}
\newcommand{\email}{atdodd@eden.rutgers.edu}
...
\begin{ressection}{Objective}
	...
	\resitem{Available as of the completion of my M.S. degree in December 2005}
\end{ressection}

\begin{ressection}{Education}

	\begin{ressubsec}{Rutgers University}{Pursuing an M.S. in Electrical and Computer Engineering}
		\ressubitem{27 credits as of May 2005 - Projected completion December 2005}
