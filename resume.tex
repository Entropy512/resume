...
\begin{ressection}{Work Experience}
	...
	\begin{ressubsec}{The Raymond Corporation}{December 2016 - Present}
		...
		\ressubitem{Worked with guidance system vendor to retune motion control parameters for Raymond's 3030 AutoStacker AGV, facilitating higher operating speeds and improved path accuracy.}
