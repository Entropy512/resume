...
\begin{ressection}{Objective}
	\resitem{Currently seeking employment involving embedded software work including low-level hardware interfacing, or electronics design involving microcontroller systems}
\end{ressection}
...
\begin{ressection}{Work Experience}
	...
	\begin{ressubsec}{Lockheed Martin Corporation}{December 2005 - July 2016}
	  \ressubitem{Troubleshot Navy fleet issue involving APN-194 radar altimeter's ability to interface with MH-60R helicopter}
          ...
          \ressubitem{Display test and measurement subject matter expert - MIL-STD-85762A high ambient contrast and NVIS compatibility testing, contrast and luminance measurement, chromaticity measurement in support of multiple platforms including MH-60R and Combat Rescue Helicopter program}
          \ressubitem{RF systems engineer, including EMI/EMC testing of the MH-60R aircraft at the systems level, and supervising MIL-STD-461 EMI testing}
	\end {ressubsec}
