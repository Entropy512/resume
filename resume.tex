...
\begin{ressection}{Work Experience}
	...
	\begin{ressubsec}{The Raymond Corporation}{December 2016 - Present}
		\ressubitem{Took over maintenance of obstruction detection subsystem for Raymond Courier AGVs - configuration of SICK FlexiSoft safety controller logic and SICK S300 safety LiDAR configuration}
		...
		\ressubitem{Developed initial prototype of the successor to IADS which integrated more tightly with the vehicle, leveraging raw LiDAR data processing to make finer-grained decisions.  This system went into production three years later.}
		\ressubitem{Developed prototype of a remote operation system for forklifts, allowing a forklift to be controlled remotely using an off-the-shelf PlayStation controller.  This system was used frequently for higher-risk lab test efforts such as dynamic stability testing.}
